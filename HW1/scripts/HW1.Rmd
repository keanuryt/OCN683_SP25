...
# here, we have 3 predictors: species, treatment (rat_removal), kipuka size (area_ha) and insect biomass (tot_arth_bm). 

# we are also looking at the interactions:
## does the treatment affect bird species differently?
## does the treatment affect the the insect biomass? 
## does the treatment change with kipuka size ? 
